...
public class LoginWindow extends javax.swing.JFrame {
     ...
     */
    public LoginWindow(AESCommunicator communicator) {
        this.communicator = communicator;
        auth = new AuthInServer(communicator);
    ...
    private void initComponents() {
        ...
        loginButton = new lagatrix.client.gui.components.simple.buttons.DefaulRoundButton();
        userInput = new lagatrix.client.gui.components.simple.input.DefaultInput();
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        try {
            if (auth.makeLogin(userInput.getValue(), 
                    passwordInput.getValue()).isCorrectResult()){
                dispose();
                new MainWindow(communicator).setVisible(true);
            } else {
    ...
    private lagatrix.client.gui.components.simple.buttons.DefaulRoundButton loginButton;
    ...
    private lagatrix.client.gui.components.simple.input.DefaultInput userInput;
